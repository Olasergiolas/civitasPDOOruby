...
module Civitas
  class TituloPropiedad
    ...
    def toString
      info = "#{@nombre}, #{@alquilerBase}, #{@factorRevalorizacion}, #{@hipotecaBase}, hipotecado: #{@hipotecado}, 
          #{@numCasas}, #{@numHoteles}, #{@precioCompra}, #{@precioEdificar}"
      
      if @propietario != nil
        info += " con propietario de nombre #{@propietario.nombre}"
      end
